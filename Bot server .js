// Gold Signal Bot — TradingView webhook → Telegram
// -------------------------------------------------
// Receives POST requests from TradingView alerts and forwards them
// as formatted messages to your Telegram channel/group.
...
// ── CONFIG ──────────────────────────────────────────────
// Fill these in (see README.md for how to get them)
...
app.post('/webhook/:secret', async (req, res) => {
  // Basic security so randoms can't spam your channel
  if (req.params.secret !== WEBHOOK_SECRET) {
    return res.status(403).send('Forbidden');
  }

  // TradingView payload can be JSON or plain text depending on your alert message
  let raw = req.body;
  let text;
  ...
  if (typeof raw === 'string') {
    ...
    // If you send JSON like {"pair":"XAUUSD","direction":"BUY","entry":"4380","sl":"4375","tp":"4392"}
